...
## recommended to provide absolute path
...
test_seeds = [
    random.randint(1, 100) for i in range(num_seeds)
]  # five random seeds to test the models on
